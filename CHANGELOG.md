...
* push by ci_bot ([822fd32](https://github.com/cube13/ehealth.schema/commit/822fd32766354263b66a9d571bfd76fa18b8612f))
...
* push by ci_bot ([db39eeb](https://github.com/cube13/ehealth.schema/commit/db39eebde4da92946f7f1ea41a5b346d3dd947b7))
...
* fix vars ([30ec475](https://github.com/cube13/ehealth.schema/commit/30ec4753c57ef69e3c5944984957ce741629bbed))
...
* fix vars ([de0897e](https://github.com/cube13/ehealth.schema/commit/de0897e7bb1bc8d111f39a06a9bbce1a60a67cfb))
...
* fix vars ([1d00e32](https://github.com/cube13/ehealth.schema/commit/1d00e32dc22932f373ccd188902d40957ad4fa49))
...
* fix vars ([7c7099c](https://github.com/cube13/ehealth.schema/commit/7c7099c8f27713afe5abc64adae19c04467a239e))
...
* fix vars ([54272d3](https://github.com/cube13/ehealth.schema/commit/54272d39c37346f3122a268b320a5c1b48129550))
...
* fix vars ([5d1cc3b](https://github.com/cube13/ehealth.schema/commit/5d1cc3bd0e57f83cd64cb88d531b8e2620a08589))
...
* fix vars ([7a43fde](https://github.com/cube13/ehealth.schema/commit/7a43fde7189d9c8107fe4a25171f42497197089e))
...
* fix vars ([26001ad](https://github.com/cube13/ehealth.schema/commit/26001ad33f42f38fdd20b9cb20c5e91eb726ff03))
...
* fix vars ([2eb01e2](https://github.com/cube13/ehealth.schema/commit/2eb01e2967a542851c89972cc1672b015943f02a))
...
* fix vars ([e8271a8](https://github.com/cube13/ehealth.schema/commit/e8271a84c6724b61aa4c1625ebd22162625e6ab5))
...
* fix vars ([1d5ddfe](https://github.com/cube13/ehealth.schema/commit/1d5ddfe1ce06f5f1ab5a9ad7e147a47f47d38ed6))
...
* fix vars ([fbb3ba7](https://github.com/cube13/ehealth.schema/commit/fbb3ba7763d153f15c7e625522ee522a29523316))
...
* fix vars ([4ffe794](https://github.com/cube13/ehealth.schema/commit/4ffe794d2cf234067656f2d98828f6354c82bc6b))
...
* fix vars ([fdfa68e](https://github.com/cube13/ehealth.schema/commit/fdfa68e1426b381ef37de4f32aa8ff6ac2423530))
...
### [4.19.1](https://github.com/edenlabllc/ehealth.schema/compare/v4.19.0...v4.19.1) (2021-05-28)

## [4.19.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.18.2...v4.19.0) (2021-05-24)


### Features

* medicalProgram schema edited ([#169](https://github.com/edenlabllc/ehealth.schema/issues/169)) ([1d2653c](https://github.com/edenlabllc/ehealth.schema/commit/1d2653ce705e0d62c8bdbcb4a99d713f5f028f35))

### [4.18.2](https://github.com/edenlabllc/ehealth.schema/compare/v4.18.1...v4.18.2) (2021-05-20)
...
* globalBudgetContract schema added ([#156](https://github.com/edenlabllc/ehealth.schema/issues/156)) ([e82ff7c](https://github.com/edenlabllc/ehealth.schema/commit/e82ff7c))
...
* rename `PersonAuthenticationMethod` field `value` to `thirdPerson`, make `isActive` field non-nullable ([15ea23a](https://github.com/edenlabllc/ehealth.schema/commit/15ea23a))



<a name="4.14.0"></a>
# [4.14.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.13.1...v4.14.0) (2020-02-24)


### Features

* add `UDI` type ([0566039](https://github.com/edenlabllc/ehealth.schema/commit/0566039))
...
<a name="4.12.1"></a>
## [4.12.1](https://github.com/edenlabllc/ehealth.schema/compare/v4.12.0...v4.12.1) (2019-12-13)


### Bug Fixes

* status added to equipment filter ([#151](https://github.com/edenlabllc/ehealth.schema/issues/151)) ([2dcdc27](https://github.com/edenlabllc/ehealth.schema/commit/2dcdc27))



<a name="4.12.0"></a>
# [4.12.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.11.0...v4.12.0) (2019-12-11)


### Features

* equipment schema added, division schema extended ([839d2e8](https://github.com/edenlabllc/ehealth.schema/commit/839d2e8))



<a name="4.11.0"></a>
# [4.11.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.10.0...v4.11.0) (2019-12-06)


### Features

* manage flags on medical program ([#148](https://github.com/edenlabllc/ehealth.schema/issues/148)) ([6e7c9e9](https://github.com/edenlabllc/ehealth.schema/commit/6e7c9e9))
...
* add `HealthcareServicesFilter` by divisionName and specialityType ([a674573](https://github.com/edenlabllc/ehealth.schema/commit/a674573))
...
* added healthcare services, employee roles queries ([#143](https://github.com/edenlabllc/ehealth.schema/issues/143)) ([503b41a](https://github.com/edenlabllc/ehealth.schema/commit/503b41a))
...
<a name="4.5.0"></a>
# [4.5.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.4.0...v4.5.0) (2019-07-10)


### Features

* add `DeclarationsTerminationJob` ([9197b1d](https://github.com/edenlabllc/ehealth.schema/commit/9197b1d))



<a name="4.4.0"></a>
# [4.4.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.3.1...v4.4.0) (2019-07-10)


### Features

* add `PersonsDeactivationJob` type ([349e8a5](https://github.com/edenlabllc/ehealth.schema/commit/349e8a5))



<a name="4.3.1"></a>
## [4.3.1](https://github.com/edenlabllc/ehealth.schema/compare/v4.3.0...v4.3.1) (2019-07-08)


### Bug Fixes

* add missing `globalParameters` field to `Query` type ([5a5ec60](https://github.com/edenlabllc/ehealth.schema/commit/5a5ec60))



<a name="4.3.0"></a>
# [4.3.0](https://github.com/edenlabllc/ehealth.schema/compare/v4.2.0...v4.3.0) (2019-07-01)


### Features

* add `GlobalParameters` type ([a4c9656](https://github.com/edenlabllc/ehealth.schema/commit/a4c9656))
...
* added `startDate`, `endDate`, `registryNumber` to ProgramMedication, CreateProgramMedicationInput, UpdateProgramMedicationInput; `registryNumber` to ProgramMedicationFilter ([#126](https://github.com/edenlabllc/ehealth.schema/issues/126)) ([baf011d](https://github.com/edenlabllc/ehealth.schema/commit/baf011d))
...
* add `EDRAddress` to EDRData in legal entity ([20fd5b3](https://github.com/edenlabllc/ehealth.schema/commit/20fd5b3))
